...
import Rodape from "../institucional/Rodape";
  ...
  return (
    <div>
          ...
          <div>
            <form>
              <div className="form-row">
                ...
                <div className="form-group col-md-6">
                  <a
                    href="/ativar-desativar-trabalhador"
                    className="btn col-md-12 btn-secondary"
                  >
                    Ativar/Desativar
                  </a>
      ...
      <div className="central border-1" style={{ marginTop: "-30px" }}>
        <div className="form-group col-md-12">
          <a href="/nova-inscricao" class="btn col-md-12 btn-primary">
            Realizar Inscrição
          </a>
        </div>

        <div className="form-group col-md-12">
          <a href="/atualizar-incricao" class="btn col-md-12 btn-primary">
            Atualizar Inscrição
          </a>
        </div>
      </div>
